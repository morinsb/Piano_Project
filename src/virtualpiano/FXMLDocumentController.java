...
//sets the recording
   ...
   private void tutorialPart2() {
    ...
    private void tutorialPart4() {
        ...
        alert.setContentText("Recording your own tunes: You can also save your recordings and play them later.  You can use the saved files to play later.  Share them with your friends and family!");
